    ...
    <div class="col-lg-12">            
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered table-condensed">
                    <thead>
                        <?php 
                        //array kolom tabel
                        $kolom=array('No','Pertanyaan','Jawaban','Nilai','Aksi'); 
        ...
        <div class="box box-danger">
            ...
            <!-- tabel kedua untuk data table -->
                ...
                <table class="table table-bordered table-condensed">
                    <thead>
                        <?php $kolom=array('No','Nama','Tipe','Bahasa','DET','RET','Aksi');  //array kolom tabel
        ...
        <div class="box box-danger">
            ...
            <!-- table ketiga untuk fungsi -->       
                    ...
                    <table class="table table-bordered table-condensed">
                        <thead>
                            <?php $kolom=array('No','Nama','Tipe','Bahasa','DET','FTR','Aksi'); 
        ...
        <a class="btn btn-danger btn-sm" href="<?php echo base_url();?>project/hitung"><i class="fa fa-calculator"></i> Hitung Estimasi</a>        
    </div>
</div>
